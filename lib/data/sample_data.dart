...
class SampleData {
  ...
  static final List<Post> posts = [
    Post(
      ...
      content:
          'Just finished an amazing hike! The view from the top was absolutely breathtaking. Nature never fails to inspire me 🌲',
      type: PostType.text,
    ...
    Post(
      ...
      content:
          'This quote has been my motivation throughout this week. What inspires you?',
      type: PostType.quote,
